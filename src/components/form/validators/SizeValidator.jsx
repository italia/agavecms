...
class SizeValidator extends Component {
  render() {
    const currentType = this.props.value.type
    const prefix = this.props.namePrefix

    const options = [
      { value: 'between', label: this.t('validators.size.between') },
      { value: 'min', label: this.t('validators.size.min') },
      { value: 'max', label: this.t('validators.size.max') },
      { value: 'eq', label: this.t('validators.size.eq') },
    ]
